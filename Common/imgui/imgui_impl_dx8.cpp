...
void ImGui_ImplDX8_RenderDrawData(ImDrawData* draw_data)
{
    ...
    //Log("1. Passed minimized check");

    // Create and grow buffers if needed
    ImGui_ImplDX8_Data* bd = ImGui_ImplDX8_GetBackendData();
    if (!bd->pVB || bd->VertexBufferSize < draw_data->TotalVtxCount)
    {
        //Log("2a. Pre-CreateVertexBuffer");
        ...
        //Log("2b. Post-CreateVertexBuffer");
    }
    if (!bd->pIB || bd->IndexBufferSize < draw_data->TotalIdxCount)
    {
        //Log("3a. Pre-CreateIndexBuffer");
        ...
        //Log("3b. Post-CreateIndexBuffer");
    }
    //Log("3c. Passed Index/Vertex Buffer Creation");
    ...
    //Log("6. Primites drawn: %d", nPrimitesDrawn);
